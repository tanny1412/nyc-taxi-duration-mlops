...
def save_model(model, output_path):
    ...
    model_file = output_path / "model.joblib"  # Correct path joining using pathlib
...
def main():
    ...
    data_path = home_dir / pathlib.Path(sys.argv[1]).resolve().relative_to(home_dir)
  # Remove any leading/trailing slashes
    ...
    train_features = pd.read_csv(data_path / "train.csv")  # Correct path joining
